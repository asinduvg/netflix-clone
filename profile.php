...
<?php require_once "includes/paypalConfig.php";?>
...
<?php require_once "includes/classes/BillingDetails.php";?>
...
if (isset($_POST['saveDetailsButton'])) {
    ...
    if ($account->updateDetails($firstName, $lastName, $email, $userLoggedIn)) {
        $detailsMessage = "<div class='alert-succcess'>
...
if (isset($_POST['savePasswordButton'])) {
    ...
    if ($account->updatePassword($oldPassword, $newPassword, $newPassword2, $userLoggedIn)) {
        $passwordMessage = "<div class='alert-succcess'>
...
<div class="settings__container column">
